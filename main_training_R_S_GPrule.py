...
class shopfloor:
    def __init__(self, env, span, m_no, wc_no, **kwargs):
        ...
        # dict_top_inds_MTGP_individuals = mtload.load_top_inds_from_final_gen(0, kwargs['dataset_name'])
        ...
        #                                                   GPrule_action = True, GPrules=dict_best_MTGP_individuals)  # modified by mengxu 2022.10.10
