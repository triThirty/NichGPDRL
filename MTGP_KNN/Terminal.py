...
class Terminal:
    def __init__(self, name, **kwargs):
        '''STEP 1: initialise terminals from the DFJSS simulator for MTGP'''
        self.name=name
        # if name == 'CPT':
    ...
    # The following terminals are used for the routing rule
    ...
    # The following terminals are used for the sequencing rule
    ...
    # The following terminals are used both for the routing rule and sequencing rule
