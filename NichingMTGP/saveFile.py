...
def save_individual(randomSeeds, dataSetName,individuals):
    with open('./NichingMTGP/train/scenario_' + str(dataSetName) + '/' + str(randomSeeds) + '_' + dataSetName+'.pickle', 'wb') as file:
...
def save_each_gen_best_individual_meng(randomSeeds, dataSetName, best_ind_all_gen):
    ...
    with open('./NichingMTGP/train/scenario_' + str(dataSetName) + '/' + str(randomSeeds) + '_meng_individual_' + dataSetName + '.pkl', "wb") as fileName_individual:
        pickle.dump(individual_dict , fileName_individual)
...
def save_top_inds_final_gen_meng(randomSeeds, dataSetName, top_inds_fitness_final_gen):
    ...
    # fileName_individual = open('./MTGP/train/' + str(randomSeeds) + '_meng_individual_' + dataSetName + '.pkl', "wb")
    # pickle.dump(individual_dict, fileName_individual)
    with open('./NichingMTGP/train/scenario_' + str(dataSetName) + '/' + str(randomSeeds) + '_meng_top_individuals_final_gen_' + dataSetName + '.pkl', "wb") as fileName_individual:
        pickle.dump(individual_dict , fileName_individual)

    return

def save_individual_to_txt(randomSeeds, dataSetName,individuals): # save individual as txt by mengxu
    file = open('./NichingMTGP/train/scenario_' + str(dataSetName) + '/' + str(randomSeeds) + '_' + dataSetName+'.txt', 'w')
...
def clear_individual_each_gen_to_txt(randomSeeds, dataSetName): # save individual as txt by mengxu
    file = open('./NichingMTGP/train/scenario_' + str(dataSetName) + '/' + str(randomSeeds) + '_' + dataSetName+'_each_gen.txt', 'w') # 'w' represent coverage, 'a' denotes not coverage
...
def save_individual_each_gen_to_txt(randomSeeds, dataSetName, individuals, gen): # save individual as txt by mengxu
    file = open('./NichingMTGP/train/scenario_' + str(dataSetName) + '/' + str(randomSeeds) + '_' + dataSetName+'_each_gen.txt', 'a') # 'w' represent coverage, 'a' denotes not coverage
    file.write('\nGen: ' + str(gen) + '\n')
    file.write('Individual:\n')
    file.write('Tree 0:\n') #routing rule
    file.write(str(individuals[0]) + '\n')
...
def save_top_inds_with_fitness_final_gen_to_txt(randomSeeds, dataSetName, individuals, fitnesses): # save individual as txt by mengxu
    file = open('./NichingMTGP/train/scenario_' + str(dataSetName) + '/' + str(randomSeeds) + '_' + dataSetName+'_top_inds_with_fitness_final_gen.txt', 'w') # 'w' represent coverage, 'a' denotes not coverage
...
def save_archive(randomSeeds, dataSetName,individuals):
    with open('./NichingMTGP/train/scenario_' + str(dataSetName) + '/' + str(randomSeeds) + '_archive' + dataSetName+'.pickle', 'wb') as file:
        pickle.dump(individuals, file, protocol=pickle.HIGHEST_PROTOCOL)
    file.close()
    return

def save_pop(randomSeeds, dataSetName,individuals):
    with open('./NichingMTGP/train/scenario_' + str(dataSetName) + '/' + str(randomSeeds) + '_pop' + dataSetName+'.pickle', 'wb') as file:
        pickle.dump(individuals, file, protocol=pickle.HIGHEST_PROTOCOL)
    file.close()
    return
...
def saveMinFitness(randomSeeds, dataSetName, min_fitness):
    fileName1= './NichingMTGP/train/scenario_' + str(dataSetName) + '/' + str(randomSeeds)+'_min_fitness' + dataSetName
    np.save(fileName1, min_fitness)
    return

def save_top_inds_fitness_final_gen(randomSeeds, dataSetName, min_fitness):
    fileName1= './NichingMTGP/train/scenario_' + str(dataSetName) + '/' + str(randomSeeds)+'_top_inds_fitness_final_gen' + dataSetName
    np.save(fileName1, min_fitness)
    return

def saveRunningTime(randomSeeds, dataSetName, running_time):
    fileName1= './NichingMTGP/train/scenario_' + str(dataSetName) + '/' + str(randomSeeds)+'_running_time' + dataSetName
