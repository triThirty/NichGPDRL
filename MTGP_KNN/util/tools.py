...
def decision_situations_generator(number_of_situations=100):
    decision_situations_dict = simulation(
        number_machines=10,
        number_jobs=1000,
        warm_up=100,
        func=0,
        due_date_tightness=4,
        utilization=0.80,
        decision_situtation=True,
    ...
    for i in range(number_of_situations):
        df_temp = decision_situations_df[
            decision_situations_df["decision"] == random_value[i]
        ]
