...
root_data_path = "./data"
target_algo = "Transformer_SSGP_0.5"
gen_interval = 1
start_gen = 0
end_gen = 99
...
# baseline_algo = [
#     p
#     for p in Path("data/13144e4dd_multi_model").rglob(
#         "Transformer_SSGP_0.8/scenario_HH"
#     )
#     if p.is_dir()
# ]

# path = Path(f"{root_data_path}/{folder_name}")


# dir_list = [p for p in path.rglob("**/scenario_*") if p.is_dir()]

# dir_list.extend(baseline_algo)

dir_list = [
    Path(f"data/13144e4dd_multi_model/{target_algo}/scenario_HH"),
    Path(f"data/ab7e39e061a_single_model_nesi_0.5/{target_algo}/scenario_HH"),
    Path(f"data/7b900646df_multi_layer_0.5/{target_algo}/scenario_HH"),
]
...
for dir_name in dir_list:
    ...
    # )
    if "multi_model" in dir_name.parts[1]:
        experiment_name = "Multi-Model"
    elif "single_model" in dir_name.parts[1]:
        experiment_name = "Single-Model"
    elif "multi_layer" in dir_name.parts[1]:
