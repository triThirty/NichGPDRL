...
if __name__ == '__main__':
    ...
    if algo == 'MTGP':
        ...
        main_experiment_GP_all_generations_test_results.main(dataset_name, seed)
        ...
        main_experiment_NichingMTGP_Integrated_DRL_R_S_single_agent_with_intermediate.main(dataset_name, seed)
    elif algo == 'intermediate_DRL_R_test':
        main_experiment_NichingMTGP_Integrated_DRL_R_with_intermediate.main(dataset_name, seed)
    elif algo == 'intermediate_DRL_S_test':
        main_experiment_NichingMTGP_Integrated_DRL_S_with_intermediate.main(dataset_name, seed)
    ...
    elif algo == 'GP_sequencing_RL_routing_test': #add by mengxu for revise the paper 2023.08.18
        main_experiment_Integrated_DRL.main(dataset_name, seed)
    elif algo == 'RL_R':
